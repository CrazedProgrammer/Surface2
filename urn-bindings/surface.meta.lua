...
return {
	...
	["palette/cc"] = surface.palette and surface.palette.cc,
	["palette/riko4"] = surface.palette and surface.palette.riko4,
	["palette/redirection"] = surface.palette and surface.palette.redirection,
